...
trait PipelineKeys {
  ...
  val stackTemplateType: SettingKey[String]      = SettingKey[String]     ("stack-template-type",  "Sets the template type do be used for the stack S3Uri [static/dynamic]")
  val stackTemplateS3Uri: SettingKey[URI]        = SettingKey[URI]        ("stack-template-s3url", "Template S3 Url Location.")
  ...
  val stackDescribe: TaskKey[Option[Stack]]  = TaskKey[Option[Stack]] ("stackDescribe", "Task used to describe stack completely")
